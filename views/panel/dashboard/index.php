                    ...
                    <div class="row col-12 justify-content-md-center">
                        <?php foreach ($childs as $item): ?>
                            <div class="col-6 col-lg-2-mb">
                                <a href="dash/result?ref_id=<?= $item->statistic_ref_id ?>">
                                    <div class="dashboard">
                                        <img src="<?php echo HSP_ASSET_URL ?>icons/bar-graph.svg" alt="sd" width="80"
                                             height="80">
                        ...
                        <div class="col-6 col-lg-2-mb">
                            <div class="dashboard">
                                <img src="<?php echo HSP_ASSET_URL ?>icons/system-update.svg" alt="sd" width="80"
                                     height="80">
