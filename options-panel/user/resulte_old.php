    ...
    <div class="box-first-natije">
        <div class="iner-box-natije">
            <div class="top-inerix-natije">
                ...
                <!-- chart -->
                <?php echo do_shortcode( '[chart_hooyo_star]' ); ?>
            </div>
        </div>
    </div>
            ...
            <div class="panel_m products elements-grid align-items-start woodmart-products-holder  woodmart-spacing-10 pagination-pagination row grid-columns-4">
                <?php foreach ( $product_ids as $product_id ): ?>
                    <?php if ( $product_id->month == 2 ): ?>
                        <div class="product-grid-item product woodmart-hover-standard  col-md-3 col-sm-4 col-6 first  type-product post-36374 status-publish first instock product_cat-672 product_cat-673 product_cat-585 has-post-thumbnail shipping-taxable purchasable product-type-simple">
                            <?php if ( $status_month_2 == 0 ): ?>
                                <p class="msg_hidden">بازی های پیشنهادی این ماه در زمان مقرر نمایش داده می شود</p>
                                <!-- image -->
                                <div class="product-element-top">
                                    <img width="300" height="300"
                                         src="<?php echo get_the_post_thumbnail_url( $product_id->product_id ) ?>"
                                         class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail <?php echo( $status_month_2 == 0 ? 'blurhooyo' : '' ); ?>">
                                </div>
                                <!-- title -->
                                <h3 class="product-title margin_prodict <?php echo( $status_month_2 == 0 ? 'blurhooyo' : '' ); ?>">
            ...
            <div class="panel_m products elements-grid align-items-start woodmart-products-holder  woodmart-spacing-10 pagination-pagination row grid-columns-4">
                <?php foreach ( $product_ids as $product_id ): ?>
                    <?php if ( $product_id->month == 3 ): ?>
                        <div class="product-grid-item product woodmart-hover-standard  col-md-3 col-sm-4 col-6 first  type-product post-36374 status-publish first instock product_cat-672 product_cat-673 product_cat-585 has-post-thumbnail shipping-taxable purchasable product-type-simple">
                            <?php if ( $status_month_3 == 0 ): ?>
                                <p class="msg_hidden">بازی های پیشنهادی این ماه در زمان مقرر نمایش داده می شود</p>
                                <!-- image -->
                                <div class="product-element-top">
                                    <img width="300" height="300"
                                         src="<?php echo get_the_post_thumbnail_url( $product_id->product_id ) ?>"
                                         class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail <?php echo( $status_month_3 == 0 ? 'blurhooyo' : '' ); ?>">
                                </div>
                                <!-- title -->
                                <h3 class="product-title margin_prodict <?php echo( $status_month_3 == 0 ? 'blurhooyo' : '' ); ?>">
                                    <?php echo get_the_title( $product_id->product_id ) ?>
                                </h3>
            ...
            <div class="panel_m products elements-grid align-items-start woodmart-products-holder  woodmart-spacing-10 pagination-pagination row grid-columns-4">
                <?php foreach ( $product_ids as $product_id ): ?>
                    <?php if ( $product_id->month == 4 ): ?>
                        <div class="product-grid-item product woodmart-hover-standard  col-md-3 col-sm-4 col-6 first  type-product post-36374 status-publish first instock product_cat-672 product_cat-673 product_cat-585 has-post-thumbnail shipping-taxable purchasable product-type-simple">
                            <?php if ( $status_month_4 == 0 ): ?>
                                <p class="msg_hidden">بازی های پیشنهادی این ماه در زمان مقرر نمایش داده می شود</p>
                                <!-- image -->
                                <div class="product-element-top">
                                    <img width="300" height="300"
                                         src="<?php echo get_the_post_thumbnail_url( $product_id->product_id ) ?>"
                                         class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail <?php echo( $status_month_4 == 0 ? 'blurhooyo' : '' ); ?>">
                                </div>
                                <!-- title -->
                                <h3 class="product-title margin_prodict <?php echo( $status_month_4 == 0 ? 'blurhooyo' : '' ); ?>">
                                    <?php echo get_the_title( $product_id->product_id ) ?>
                                </h3>
            ...
            <div class="panel_m products elements-grid align-items-start woodmart-products-holder  woodmart-spacing-10 pagination-pagination row grid-columns-4">
                <?php foreach ( $product_ids as $product_id ): ?>
                    <?php if ( $product_id->month == 5 ): ?>
                        <div class="product-grid-item product woodmart-hover-standard  col-md-3 col-sm-4 col-6 first  type-product post-36374 status-publish first instock product_cat-672 product_cat-673 product_cat-585 has-post-thumbnail shipping-taxable purchasable product-type-simple">
                            <?php if ( $status_month_5 == 0 ): ?>
                                <p class="msg_hidden">بازی های پیشنهادی این ماه در زمان مقرر نمایش داده می شود</p>
                                <!-- image -->
                                <div class="product-element-top">
                                    <img width="300" height="300"
                                         src="<?php echo get_the_post_thumbnail_url( $product_id->product_id ) ?>"
                                         class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail <?php echo( $status_month_5 == 0 ? 'blurhooyo' : '' ); ?>">
                                </div>
                                <!-- title -->
                                <h3 class="product-title margin_prodict <?php echo( $status_month_5 == 0 ? 'blurhooyo' : '' ); ?>">
                                    <?php echo get_the_title( $product_id->product_id ) ?>
                                </h3>
            ...
            <div class="panel_m products elements-grid align-items-start woodmart-products-holder  woodmart-spacing-10 pagination-pagination row grid-columns-4">
                <?php foreach ( $product_ids as $product_id ): ?>
                    <?php if ( $product_id->month == 6 ): ?>
                        <div class="product-grid-item product woodmart-hover-standard  col-md-3 col-sm-4 col-6 first  type-product post-36374 status-publish first instock product_cat-672 product_cat-673 product_cat-585 has-post-thumbnail shipping-taxable purchasable product-type-simple">
                            <?php if ( $status_month_6 == 0 ): ?>
                                <p class="msg_hidden">بازی های پیشنهادی این ماه در زمان مقرر نمایش داده می شود</p>
                                <!-- image -->
                                <div class="product-element-top">
                                    <img width="300" height="300"
                                         src="<?php echo get_the_post_thumbnail_url( $product_id->product_id ) ?>"
                                         class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail <?php echo( $status_month_6 == 0 ? 'blurhooyo' : '' ); ?>">
                                </div>
                                <!-- title -->
                                <h3 class="product-title margin_prodict <?php echo( $status_month_6 == 0 ? 'blurhooyo' : '' ); ?>">
                                    <?php echo get_the_title( $product_id->product_id ) ?>
                                </h3>
